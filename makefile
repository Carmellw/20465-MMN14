...
label_linked_list.o: label_linked_list.c label_linked_list.h label.h
	gcc -c -ansi -Wall -pedantic label_linked_list.c -o label_linked_list.o
second_pass.o: second_pass.c line_utils.o instruction.o second_pass.h status_codes.h consts.h line_utils.h instruction.h
